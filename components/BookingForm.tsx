...
export function BookingForm({ doctors }: BookingFormProps) {
	...
	return (
		<div className="panel page-enter p-5 sm:p-6">
			...
			<form onSubmit={onSubmit} className="mt-6 space-y-4">
					...
					<div className="grid gap-4 sm:grid-cols-2">
						...
						<div>
							...
							{doctor && date && availableTimes.length === 0 ? (
								<p className="mt-1 text-xs font-semibold text-[#a2473a]">No slots left on this date for this doctor.</p>
							) : null}
						</div>
					</div>
