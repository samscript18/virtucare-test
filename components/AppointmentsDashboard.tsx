...
export function AppointmentsDashboard() {
	...
	return (
		<section className="page-enter space-y-4">
			{booked ? (
				<p className="panel border-[#b7d9d4] bg-[#ebf8f5] px-4 py-3 text-sm font-semibold text-[#1f6b63]">
			...
			{appointments.length === 0 ? (
				...
				<ul className="grid gap-3">
					{appointments.map((appointment) => (
						<li key={appointment.id} className="panel grid gap-3 p-4 sm:grid-cols-[1fr_auto] sm:items-center">
							<div>
							...
							<button
								...
								className="btn-ghost border-[#e2c2bd] bg-[#fff6f4] text-[#a2473a] hover:bg-[#ffecea]"
							>
								Cancel
							</button>
						</li>
